...
// Default Loaded Table
toTable("WCA_relay_single.csv");

function configTable(group, maxRows=rowMax, id="table-container") {
  document.getElementById("myTable").remove();
  toTable(`WCA_relay_${group}.csv`, id, maxRows);
  currTable = group;
}

let rowMax = 1001;
let currTable = "single";
